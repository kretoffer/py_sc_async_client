...
py-sc-async-client is available on [PyPI](https://pypi.org/project/py-sc-async-client/):

```sh
$ pip install py-sc-async-client
```

py-sc-async-client officially supports Python 3.8+. -->
...
- *sc_async_client.client*.**is_connected**()
...
- *sc_async_client.models*.**ScTemplate**
...
- *sc_async_client.models*.**ScLinkContent**
