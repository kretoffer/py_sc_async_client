from sc_async_client.constants.sc_type import bitmasks as b
...
CONST_ACTUAL_TEMP_ARC = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC
)
VAR_ACTUAL_TEMP_ARC = ScType(b.SC_TYPE_VAR | b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC)
CONST_INACTUAL_TEMP_ARC = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC
)
VAR_INACTUAL_TEMP_ARC = ScType(
    b.SC_TYPE_VAR | b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC
)
...
ACTUAL_TEMP_POS_ARC = ScType(
    b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_POS_ARC
)
INACTUAL_TEMP_POS_ARC = ScType(
    b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_POS_ARC
)
...
CONST_ACTUAL_TEMP_POS_ARC = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_POS_ARC
)
CONST_INACTUAL_TEMP_POS_ARC = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_POS_ARC
)
...
VAR_ACTUAL_TEMP_POS_ARC = ScType(
    b.SC_TYPE_VAR | b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_POS_ARC
)
VAR_INACTUAL_TEMP_POS_ARC = ScType(
    b.SC_TYPE_VAR | b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_POS_ARC
)
...
ACTUAL_TEMP_NEG_ARC = ScType(
    b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_NEG_ARC
)
INACTUAL_TEMP_NEG_ARC = ScType(
    b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_NEG_ARC
)
...
CONST_ACTUAL_TEMP_NEG_ARC = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_NEG_ARC
)
CONST_INACTUAL_TEMP_NEG_ARC = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_NEG_ARC
)
...
VAR_ACTUAL_TEMP_NEG_ARC = ScType(
    b.SC_TYPE_VAR | b.SC_TYPE_ACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_NEG_ARC
)
VAR_INACTUAL_TEMP_NEG_ARC = ScType(
    b.SC_TYPE_VAR | b.SC_TYPE_INACTUAL_ARC | b.SC_TYPE_TEMP_ARC | b.SC_TYPE_NEG_ARC
)
...
CONST_NODE_LINK_CLASS = ScType(
    b.SC_TYPE_CONST | b.SC_TYPE_NODE_LINK | b.SC_TYPE_NODE_CLASS
)
